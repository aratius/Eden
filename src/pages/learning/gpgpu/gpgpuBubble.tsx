...
import WebGLGPGPUBubble from '../../../components/webgl/learning/gpgpu/bubble/bubble'
...
export default class Index extends Component<Props> {
	...
	private canvas: WebGLGPGPUBubble = null
	...
	private onReadyCanvas = (node: HTMLCanvasElement): void => {
		if(!node) return
		this.canvas = new WebGLGPGPUBubble(node, null, null)
		this.canvas.init()
	}
