...
import WebGLFaceDivision from '../../components/webgl/work/faceDivision/faceDivision'
...
export default class Index extends Component<Props> {
	...
	private canvas: WebGLFaceDivision = null
	...
	private onReadyCanvas = (node: HTMLCanvasElement) => {
		if(node == null) return
		this.canvas = new WebGLFaceDivision(node, null, null)
		this.canvas.init()
	}
