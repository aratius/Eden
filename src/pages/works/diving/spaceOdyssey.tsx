...
import SpaceOdyssey from '../../../components/webgl/work/diving/spaceOdyssey/spaceOdyssey'
...
export default class Index extends Component<Props> {
	...
	private canvas: SpaceOdyssey = null
	...
	private onReadyCanvas = (node: HTMLCanvasElement) => {
		if(node == null) return
		this.canvas = new SpaceOdyssey(node, null, null)
		this.canvas.init()
	}
