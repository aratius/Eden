...
export default class Info extends Component<Props> {
	...
	public appear(): void {
		...
		if(this.bg.classList.contains(styles.invisible)) this.bg.classList.remove(styles.invisible)
	...
	public disappear(): void {
		...
		if(!this.bg.classList.contains(styles.invisible)) this.bg.classList.add(styles.invisible)
