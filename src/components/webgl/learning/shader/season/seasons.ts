...
import DomainWarpMaterial from "./seasonMat";

export default class Seasons extends WebGLCanvasBase {
  ...
  private _initPlane(): void {
    ...
    for(let i = 0; i < 1; i++) {
      ...
      gsap.to(plane.rotation, {z: Math.PI*2, ease: "linear", duration: 60, repeat: -1})
    }
  }
